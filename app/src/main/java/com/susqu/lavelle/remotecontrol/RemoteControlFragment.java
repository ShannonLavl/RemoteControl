package com.susqu.lavelle.remotecontrol;
...
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // a listener for the number buttons
        ...
        // set up the Buttons for the number buttons
        ...
        // set up the Buttons for the bottom row: Delete, 0, Enter
